...
function init() {
	...
	$('#delOkBtn').click(() => {
		...
		$.ajax({
			url: 'sell/del' + $('#${trade.tradeNum}').val(),
			method: 'delete'
		}).done()
	})
   ...
   <header class='container-fulid border fixed-top'>
      <div class='row justify-content-between align-items-center'>
         ...
         <div class='col text-right mr-3'>
            <a class='btn btn-lg' href='../sell'><i class='fas fa-xmark'></i></a>
         </div>
      </div>
   </header>
	<div class='container'>
		<div id='mainContent' class='row'>
			<div id='productImg' class='col carousel border'>
		...
		<div class='row pt-4 pb-4'>
			<div class='col-12'>
				...
				<sapn class='small pr-3'>${sell.nickName}</sapn>
         ...
         <div class='d-flex justify-content-center align-items-center'>
            <div class='btn-group btn-block btnBack p-2'>
               ...
               <div class='dropdown-menu w-50'>
                  <a id='fixBtn' class='dropdown-item' href='fix?tradeNum=${trade.tradeNum}'>수정</a><hr>
                  <a type='button' id='delPost' class='dropdown-item'>삭제</a><hr>
   ...
   <div id='commentArea' class='container mt-4 mb-5'>
	...
	<div id='commentArea' class='container mt-4 mb-5'>
      ...
      <div id='chatBtn'  class='row fixed-bottom d-sm-none'>      
         <div class='col'>
            <a href="../chat/" class='btn btn-block p-2'>
	...
	<div  class='container-fulid'>
		<div id='chatBtnCom'  class='goChatBtn row fixed-bottom d-none d-md-inline'>		
			<div class='col'>
				<a href="chat/room?roomNum=${chat.roomNum}" class='btn p-2'>
					<i class="fa-solid fa-comments fa-xl"></i>
      ...
      <div class='modal-dialog modal-dialog-centered'>
         <div class='modal-content'>
            ...
            <div id='modalBtn' class='modal-footer'>
               ...
               <a type='button' id='delOkBtn' class='btn yesBtn' data-dismiss="modal" href='/sell/del?tradeNum=${trade.tradeNum}'>예</a>
            </div>
         </div>
      </div>
   </div>
