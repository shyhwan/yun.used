...
function reservationList() {
	...
	$.ajax({
		...
		if(trades.length) {
			...
			$('#reservationList').append(reservationList.join(''));
		} else {
			$('#reservationList').empty()
			$('#reservationList').append('<li class="text-center mt-3">예약 된 거래가 없습니다.</li>')
		}
	})		
}
...
<body>
	...
	<div class="container min-vh-100">
		<div id='mainContent' class="row justify-content-center">
			<ul id='reservationList' class='col list-unstyled p-4'>
