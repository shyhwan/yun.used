	...
	<header class='container-fulid border fixed-top'>
		<div class='row justify-content-between align-items-center p-2'>
			<div class='col ml-3 d-flex'>
				<strong>구매 글 작성</strong>
			</div>
			<a class='btn btn-lg mr-3' href='/buy'><i class='fas fa-xmark'></i></a>
		</div>
	</header>
		...
		<div id='mainContent' class="row">
			<form method='post' action='add' class='col form' encType='multipart/form-data'>
				<div id='imgArea' class='row form-group ml-2 filebox'>
					...
					<input type='file' id='tradeImgFile' name='tradeImgFile' class='pb-5 form-control' accept='image/*' multiple/>
				</div>
				
				<div class='row form-group border'>
					<input id='title' name='title' type='text' class='m-1 form-control input-lg border-0' placeholder='글 제목'/>
				</div>
				<div class='row m-1 align-items-center flex-column form-group'>
					...
					<input id='price' name='price' class='col mt-1 form-control' type='text' onkeyup='comma(this)' placeholder='가격' min='0'/>
				</div>
				<div class='row form-group border-top'>
					<textarea id='contents' name='contents' class='m-1 form-control border-0' rows='8' placeholder='글 내용'></textarea>
				</div>
