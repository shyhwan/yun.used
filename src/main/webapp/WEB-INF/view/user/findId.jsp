...
function findId() {
	if(isVal($('#userName')) && isVal($('#phoneNum'))) {
		$('form').submit()
	}
}
...
<body>
	...
	<div class='container min-vh-100'>
		<div id='mainContent' class='row'>
			<form action='checkId' method='post' class='col m-3'>
				<div class='form-group p-3 foundId'>
	...
	<footer class='container-fulid border mt-5 p-3'>
		<div class='row m-3'>
			...
			<div class='col text-center m-3'>
				<span>중고 RECYLE 경기도 고양시 일산동구 마두동 중앙로11 메트로빌팅 6층 대표이사: 윤승환</span><br>
