		...
		<div id='mainContent' class="row">
			<form class='col form'>
				<div class='row form-group border-top p-2'>
					<input id='title' type='text' class='form-control input-lg border-0' placeholder='글 제목'/>
				</div>
				<div class='row form-group border-top'>
					<textarea id='contents' class='form-control border-0' rows='20' placeholder='글 내용'></textarea>
				</div>
